...
//            e.printStackTrace();
     ...
     */
    public static void configRecyclerView(final RecyclerView recyclerView, RecyclerView.LayoutManager layoutManager, RecyclerView.ItemDecoration itemDecoration) {
        // 设置RecyclerView管理器
